...
class AddAgronomist extends StatefulWidget {
  const AddAgronomist({Key? key}) : super(key: key);

  @override
  State<AddAgronomist> createState() => _AddAgronomistState();
}



class _AddAgronomistState extends State<AddAgronomist> {
 ...
 //variable for choosed file
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Add Agronomist"),
      ),
      body: Container(
  ...
  Future<void> AddAnimalFeeds(BuildContext context) async {
    if(name.text.isEmpty){
      ...
      http.Response  isUploaded = await AddVendorService.addAgronomist(name.text, expertise.text, charge.text, description.text, selectedAvailability!, selectedCrop!, image?.path);
